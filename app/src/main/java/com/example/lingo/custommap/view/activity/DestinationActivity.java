...
import com.example.lingo.custommap.presenter.DestinationActivityPresenter;
...
public class DestinationActivity extends AppCompatActivity {
    ...
    private DestinationActivityPresenter presenter;
    private LinearLayout myLocation;
    private LocateService mLocateService;
    private List<LatLng>des=new ArrayList<>();
    private LatLng selectedDes;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter=new DestinationActivityPresenter(DestinationActivity.this,mLocateService,mHandler,mSuggestion);
        initView();
    }
    ...
    private void initView() {
        ...
        adapter=new SimpleAdapter(DestinationActivity.this,list,R.layout.listitem,new String[]{"location"},new int[]{R.id.location});
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                location.setText((String)list.get(position).get("location"));
                selectedDes=des.get(position);
        ...
        sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(location.getText().toString().equals("")){
                    ...
                    presenter.sure(location.getText().toString().trim(),selectedDes,selectedCity);
                }
            }
        });
    ...
    public void showMessage(String text){
        Toast.makeText(DestinationActivity.this,text,Toast.LENGTH_SHORT).show();
    }
