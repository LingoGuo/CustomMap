...
public class DestinationActivityPresenter {
    private DestinationActivity view;
    ...
    public DestinationActivityPresenter(DestinationActivity view,LocateService mLocationService,Handler mHandler, final Suggestion mSuggestion){
        this.view=view;
    ...
    public void sure(String location, LatLng des,String city){
        Intent intent=new Intent();
        intent.putExtra("destination",location);
        intent.putExtra("des",des);
        intent.putExtra("city",city);
        view.setResult(Code.DESTINATIONACTIVITY_RESULT_CODE,intent);
        view.finish();
    }
